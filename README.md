...
Some parts have associated rights waived with [CC0-1.0](https://directory.fsf.org/wiki/License:CC0): things under directory `i18nx`, `zh-conv`, and the artwork `static/kitty.svg` along with its derivatives.
